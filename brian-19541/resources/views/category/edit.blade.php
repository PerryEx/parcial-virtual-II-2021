            ...
            <div class="col-md-8">
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('category.update',['category'=>$category->id])}}" method="POST" novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control col-md-auto"  type="text"  name="name_category" id="name_category" value="{{old('category',$category->name_category)}}"
                                       required="required"
                                >
